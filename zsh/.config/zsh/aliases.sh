...
alias ksbx="kubectl --context=sandbox-east-1-adminRole"
alias ksbxutil="kubectl --context=sandbox-east-1-utility-adminRole"
...
alias k9sbx="k9s --context=sandbox-east-1-adminRole"
alias k9sbxutil="k9s --context=sandbox-east-1-utiliy-adminRole"
